        ...
        <div className='grid grid-flow-row max-w-[500px] mx-auto items-center text-center'>
          <div>
            <div className='grid grid-cols-3'>
              <p className='px-2 py-1 border border-orange-900 font-bold'>Distance in km</p>
              <p className='px-2 py-1 border border-orange-900 font-bold'>Time</p>
              <p className='px-2 py-1 border border-orange-900 font-bold'>Pace in min/km</p>
            </div>
            {equivalence && equivalence?.map(elem => (
              <div key={elem.distance} className='grid grid-cols-3 hover:bg-amber-400 cursor-default md:hover:scale-110 duration-500' >
                <p className='px-2 py-1 border border-orange-900 font-bold'>{Number.isInteger(elem.distance) ? elem.distance : elem.distance === 21.1 ? "Half marathon" : "Marathon"}</p>
