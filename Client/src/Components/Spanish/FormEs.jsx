  ...
  return (
    <form className='w-full flex flex-col items-center text-orange-900 shadow-md shadow-amber-900' onSubmit={(e) => handleOnSubmit(e)}>
        ...
        <div className='grid grid-cols-3 md:grid-cols-2 gap-2 md:gap-5 pt-2 '>
          ...
          <div className='col-span-2 md:col-span-1'>
            <input type='number' name='hour' placeholder='hora' value={timeInputs.hour} onChange={handleTimeChange} onFocus={handleTimeFocus} onBlur={handleTimeBlur} min={0} className='w-10 inputForm' />
            <label>h&nbsp;</label>
            ...
            <label>min&nbsp;</label>
            <input type='number' name='seconds' placeholder='seg' value={timeInputs.seconds} onChange={handleTimeChange} onFocus={handleTimeFocus} onBlur={handleTimeBlur} min={0} max={59} className='w-10 inputForm' />
            <label>seg&nbsp;</label>
          </div>
          ...
          <div className='col-span-2 md:col-span-1'>
              ...
              <label>min&nbsp;</label>
              <input type='number' name='seconds' placeholder='seg' value={paceInputs.seconds} onChange={handlePaceChange} onFocus={handlePaceFocus} onBlur={handlePaceBlur} min={0} max={59} className='w-10 inputForm' />
              <label>seg&nbsp;</label>
          </div>
